...
public class CommonExcelReader {
     ...
     * @return a HashMap containing the data read from the Excel file, with the keys being the
     * column names and the values being the corresponding cell values
    ...
    public Map<String, String> getDataFromExcel(String testCase, String workbookName, String sheetName) throws IOException {
        ...
        FileInputStream inputStream = new FileInputStream("src\\test\\resources\\TestData\\" + workbookName + " (1).xlsx");
